...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"case-converter.js":[function(require,module,exports) {
var textarea = document.getElementById('conversion');
var upperCaseBtn = document.getElementById('upperCaseBtn');
var lowerCaseBtn = document.getElementById('lowerCaseBtn');
var sentenceCaseBtn = document.getElementById('sentenceCaseBtn');
var capitalizedCaseBtn = document.getElementById('capitalizedCaseBtn');
var copyTextBtn = document.getElementById('copyBtn');
var numCharsElem = document.getElementById('numChars');
var numWordsElem = document.getElementById('numWords');
var numSentencesElem = document.getElementById('numSentences');
...
var capitalizeChars = function capitalizeChars(splitter) {
  var initialText = textarea.value.split(splitter);
  var capitalizedText = [];
...
var toSentenceCase = function toSentenceCase() {
  toLowerCase();
  textarea.value = capitalizeChars('. ');
  textarea.value = capitalizeChars('.');
};

var toCapitalizedCase = function toCapitalizedCase() {
  toLowerCase();
  textarea.value = capitalizeChars(' ');
};
...
var countWords = function countWords() {
  var textContent = textarea.value.split(" ");
  numWordsElem.innerText = textarea.value === "" ? "0" : textContent.length.toString();
};

var countSentences = function countSentences() {
  var textContent = textarea.value.split(". ");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","case-converter.js"], null)
//# sourceMappingURL=/case-converter.acc8ee7c.js.map